        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                <div class="flex items-center gap-6">
                    ...
                    <a href="{{ route('dashboard.rounds.show', 'round1') }}" class="text-sm text-gray-600 hover:text-gray-900 {{ request()->is('dashboard/rounds/round1') ? 'font-medium text-gray-900' : '' }}">R1 ({{ $round1Count }})</a>
                    ...
                    <a href="{{ route('dashboard.rounds.show', 'longlist') }}" class="text-sm text-gray-600 hover:text-gray-900 {{ request()->is('dashboard/rounds/longlist') ? 'font-medium text-gray-900' : '' }}">LL ({{ $longlistCount }})</a>
                    <a href="{{ route('dashboard.rounds.show', 'shortlist') }}" class="text-sm text-gray-600 hover:text-gray-900 {{ request()->is('dashboard/rounds/shortlist') ? 'font-medium text-gray-900' : '' }}">SL ({{ $shortlistCount }})</a>
